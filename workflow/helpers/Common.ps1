...
function Get-TraceImplementationFileMap {
    return @{
        'PlacesGathererRunner' = 'ingest/places/PlacesGatherer.Console/Program.cs'
        'PlacesGatherer.Console.Services.GooglePlacesClient' = 'ingest/places/PlacesGatherer.Console/Services/GooglePlacesClient.cs'
        'PlacesGatherer.Console.Services.PlacesSearchExpander' = 'ingest/places/PlacesGatherer.Console/Services/PlacesSearchExpander.cs'
        'PlacesGatherer.Console.Services.PlaceNameNormalizer' = 'ingest/places/PlacesGatherer.Console/Services/PlaceNameNormalizer.cs'
        'PlacesGatherer.Console.Secrets.SecretProviderFactory' = 'ingest/places/PlacesGatherer.Console/Secrets/SecretProviderFactory.cs'
        'PlacesGatherer.Console.Secrets.LocalConfigurationSecretProvider' = 'ingest/places/PlacesGatherer.Console/Secrets/LocalConfigurationSecretProvider.cs'
        'MasterListBuilderRunner' = 'ingest/places/MasterListBuilder.Console/Program.cs'
        'LocationAssemblerRunner' = 'ingest/assemble/LocationAssembler.Console/Program.cs'
        'KmlConsoleRunner' = 'generate/KmlGenerator.Console/Program.cs'
        'KmlTilerRunner' = 'generate/KmlTiler.Console/Program.cs'
        'ArcGeometryExtractorApp' = 'ingest/authority/ArcGeometryExtractor.Console/Program.cs'
        'KmlGenerator.Core.Services.KmlGenerationService' = 'platform/core/KmlGenerator.Core/Services/KmlGenerationService.cs'
    }
}

function Get-ProxiedRuntimeFiles {
    return @(
        'ingest/authority/ArcGeometryExtractor.Console/Program.cs'
        'generate/KmlGenerator.Console/Program.cs'
        'platform/core/KmlGenerator.Core/Services/KmlGenerationService.cs'
        'generate/KmlTiler.Console/Program.cs'
        'ingest/assemble/LocationAssembler.Console/Program.cs'
        'ingest/places/MasterListBuilder.Console/Program.cs'
        'ingest/places/PlacesGatherer.Console/Program.cs'
        'ingest/places/PlacesGatherer.Console/Secrets/LocalConfigurationSecretProvider.cs'
        'ingest/places/PlacesGatherer.Console/Secrets/SecretProviderFactory.cs'
        'ingest/places/PlacesGatherer.Console/Services/GooglePlacesClient.cs'
        'ingest/places/PlacesGatherer.Console/Services/PlaceNameNormalizer.cs'
        'ingest/places/PlacesGatherer.Console/Services/PlacesSearchExpander.cs'
    )
}
...
function Write-CSharpFileClassificationReport {
    ...
    $items = Get-ChildItem -Path $RepoRoot -Recurse -Filter *.cs | Where-Object {
        ...
        $classification = if ($relativePath -like 'tests/KmlGenerator.Tests/*' -or $relativePath -like 'tests/PlacesGatherer.Console.Tests/*') {
