...
public static class NativeGeometryLibrary
{
    ...
    private static IntPtr ResolveLibrary(string libraryName, Assembly assembly, DllImportSearchPath? searchPath)
    {
        ...
        {
            Path.Combine(repoRoot, ".native", "build", "platform-native-kml_geometry_native", "Release", "kml_geometry_native.dll"),
        ...
        throw new DllNotFoundException("Could not locate kml_geometry_native.dll. Build the native project under .native/build/platform-native-kml_geometry_native first.");
    }
