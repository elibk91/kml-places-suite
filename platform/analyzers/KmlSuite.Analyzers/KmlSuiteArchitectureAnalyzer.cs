...
public sealed class KmlSuiteArchitectureAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly ImmutableHashSet<string> CompositionRootFiles = ImmutableHashSet.Create(
        StringComparer.OrdinalIgnoreCase,
        "ingest/authority/ArcGeometryExtractor.Console/Program.cs",
        "generate/KmlGenerator.Api/Program.cs",
        "generate/KmlGenerator.Console/Program.cs",
        "generate/KmlTiler.Console/Program.cs",
        "ingest/assemble/LocationAssembler.Console/Program.cs",
        "ingest/places/MasterListBuilder.Console/Program.cs",
    ...
    private static bool IsTestFile(string filePath) =>
        filePath.StartsWith("tests/KmlGenerator.Tests/", StringComparison.OrdinalIgnoreCase)
        || filePath.StartsWith("tests/PlacesGatherer.Console.Tests/", StringComparison.OrdinalIgnoreCase);
}
